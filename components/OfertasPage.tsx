        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-gradient-to-r from-brand-purple/20 to-white border border-brand-purple/30 rounded-xl p-6 md:p-8 mb-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-sm">
                <div className="text-center md:text-left flex-1">
                    <h3 className="text-2xl md:text-3xl font-bold text-brand-purple-dark mb-3">¡Oferta Destacada!</h3>
                    <p className="text-lg md:text-xl text-gray-800 leading-relaxed">
                        Descubre la línea <strong>Duologi</strong> para un cabello perfecto. Acondicionadores desde <span className="font-bold text-3xl text-red-600 align-middle">7,99€</span>
                    </p>
                    <p className="text-gray-700 mt-2">
                        Lo mejor para la rutina capilar de invierno.
                    </p>
                    <p className="text-xs text-gray-500 mt-4 italic">*Oferta válida durante el Catálogo 17.</p>
                </div>
            ...
            <div className="mb-16">
                 <div className="flex items-center gap-2 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-black">Acondicionadores Duologi en Oferta</h3>
                 </div>
            ...
            <div className="mb-16" id="seleccion-oferta">
                 <div className="flex items-center gap-2 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-black">Top Ventas del Catálogo</h3>
                 </div>
                 <p className="text-gray-600 mb-6 ml-10">Los favoritos de nuestros clientes para esta temporada.</p>
            ...
            {/* Other Offers */}
             {otherDuologiProducts.length > 0 && (
                <div className="mb-16">
                    <h3 className="text-xl font-bold text-black mb-6 border-b pb-2">Más cuidado Duologi</h3>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
             ...
             {giftProducts.length > 0 && (
                <div className="mb-12">
                    <h3 className="text-xl font-bold text-black mb-6 border-b pb-2">Ideas para Regalar</h3>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
